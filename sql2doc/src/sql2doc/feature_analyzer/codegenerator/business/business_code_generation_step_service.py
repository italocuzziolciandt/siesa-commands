...
from feature_analyzer.codegenerator.business.procedure_dependency_processor import (
    ProcedureDependencyProcessor,
)
from feature_analyzer.models.code_result_model import CodeResultModel
...
class BusinessCodeGenerationStepService(StepExecutionInterface):
    """
    ...
    def execute(self, data_wrapper: DataWrapperModel) -> DataWrapperModel:
        ...
        """
        try:
            if not feature_toggle_instance.is_backend_business_code_enabled():
                self.logger.info(
